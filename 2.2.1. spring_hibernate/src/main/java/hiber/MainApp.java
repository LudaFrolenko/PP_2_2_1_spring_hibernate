...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      System.out.println(userService.getUserByCar("model2", 2).getCar() + " владелец model2 :  " + userService.getUserByCar("model2", 2).getFirstName());
      System.out.println("данные по model3  " + userService.getUserByCar("model3", 3));
